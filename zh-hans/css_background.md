...
| 属性 | 描述 |
| :--- | :--- |
| **`background`** | **简写属性**，用于一次性**集中定义各种背景属性** 。建议遵循此顺序:`background:bg-color bg-image position/bg-size bg-repeat bg-origin bg-clip bg-attachment initial/inherit;`也可更具情况省略。|
